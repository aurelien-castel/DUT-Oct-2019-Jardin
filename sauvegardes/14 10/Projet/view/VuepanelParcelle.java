...
public class VuepanelParcelle extends JPanel {
      ...
      public VuepanelParcelle() {
            ...
            /*addLegume.addActionListener(new ActionListener() {
      ...
      public JButton buttonParcelle(Parcelle p) {
            ...
            button.add(new JLabel(new ImageIcon(dye(image, new Color(175, 195, 210, 128), list))));
      ...
      private static BufferedImage dye(BufferedImage image, Color color, List<String> list) {
