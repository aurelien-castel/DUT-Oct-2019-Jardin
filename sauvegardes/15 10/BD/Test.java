...
public class Test{
	...
	public static void main(String[] args) {
		...
		Parcelle p0 = jfbd.AddJardin("Tdgest", 100, 300);
		...
		Legume beetBD = null;
		try {
			poireauBD = lfbd.AddLegume("Poireau de Carentan", FamilleLegume.ALLIACEES, 000000000100, 0b011111111000);
		...
		//1Legume tst = leg.next();
		//System.out.println(tst.toString(TextStyle.FULL));
