...
public class MethodeBD{
    protected String bd_url  = Config_bd.geturl();
    protected String bd_user = Config_bd.getuser();
    protected String bd_pwd  = Config_bd.getpwd();

    protected String sql;
    protected Connection con;
    protected Statement stmt;
    protected ResultSet res;
    protected int nbResultat;

    protected StringBuilder sb;
    protected Boolean problem, vide;

    protected ArrayList<String> resultat = new ArrayList<String>();
